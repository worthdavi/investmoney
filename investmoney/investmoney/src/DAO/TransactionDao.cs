...
{
    /// <summary>
    /// A classe **TransactionDao** é uma classe DAO, responsável por abragnder todas a ações referente a Transaction que interage com o banco de dados.
    /// </summary>
    class TransactionDao
    {
        /// <summary>
        /// O metodo retorna histórico de transação dousuário.
        /// </summary>
        /// <param name="user">O usuário que dejea buscar o histórico de transação.</param>
        /// <returns>Retorna o histórico de transação do usuário..</returns>
