...
namespace investmoney.src.Models
{
    ...
    class Wallet
    {
        ...
        /// <summary>
        /// Os metodos pegar e/ou altera a propriedade boughtDate.
        /// </summary>
        /// <returns>Não há retorno.</returns>
        public long boughtDate { get; set; }

        /// <summary>
        /// Os metodos pegar e/ou altera a propriedade boughtValue.
        /// </summary>
        /// <returns>Não há retorno.</returns>
        ...
        /// <summary>
        /// O metodo atribui a propriedade id da Wallet.
        /// </summary>
        /// <returns>Não há retorno.</returns>
        public int getId()
        {
